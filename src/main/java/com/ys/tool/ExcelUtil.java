...
public class ExcelUtil {
	...
	public static HSSFWorkbook createExcelFile(String fileName, List<String> heads, List<List<String>> dataList) {
		...
		if (StringUtils.isEmpty(fileName) || null == heads || null == dataList) {
			...
			HSSFSheet sheet = wb.createSheet(fileName);
			HSSFCellStyle HSSFcs = wb.createCellStyle();
			HSSFRow row = sheet.createRow(0);
	 ...
	 * @param convertMap 转换的准则,例如 Map<String, String> headMap = new
	 ...
	 */
	public static List<HashMap<String, String>> convertExcelDataToMapData(Map<String, String> convertMap,
	...
	public static <T> List<T> convertExcelDataToClassData(Map<String, String> convertMap, String fileName,
			Class<T> class1) throws InstantiationException, IllegalAccessException, IOException, NoSuchFieldException,
			SecurityException {
	 ...
	 * @return: List<Object>
	 */
	public static <T> List<T> convertExcelDataToClassDataWithPrimaryKey(Map<String, String> headNameMap,
			InputStream ips, Class<T> class1) throws InstantiationException, IllegalAccessException, IOException,
	 ...
	 * @Description: setFieldValue 设置JavaBean属性的数据,以便于支持除了String类型外的其他数据类型,例如int,
	 *               long,double,date
	 ...
	 */
	public static <T> List<T> convertExcelDataToClassDataWithPrimaryKey(Map<String, String> headNameMap,
			String fileName, Class<T> class1) throws InstantiationException, IllegalAccessException, IOException,
			NoSuchFieldException, SecurityException {
